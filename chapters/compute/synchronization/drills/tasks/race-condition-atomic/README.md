...
Go to `race-condition-atomic/support/race_condition_atomic.c` and complete the function `decrement_var()`.
...
Go to `race-condition-atomic/support/race_condition_atomic2.c`, compile and run the code.
